...
If you'd met me in 2018, I'd have walked you through [5Miles](https://5miles.com) — the C2C local marketplace I built from scratch in Dallas, Texas — and how it ended up named Entrepreneur of the Year by *D CEO Magazine*.

If you meet me today, I'd point you at ByteTrade Lab's [Olares](https://www.olares.com/) — our personal-cloud OS and the Olares One hardware that goes with it — and at the next generation of American creators growing up on Clapper.

Twenty years, five companies, two countries, three books. It looks scattered on a CV, but there's actually a single thread running through all of it: **I try to build products the way a physicist runs experiments — observe, hypothesize, test, iterate.**
...
Those two years also became the source material for three books on UNIX systems and search engines that stayed in print for years afterward.

---

## III. Alibaba / Taobao: Four Years Inside Chinese E-commerce's Wildest Era (2007–2011)
...
## IV. LightInTheBox (NYSE: LITB): Selling "Made in China" to the World (2011–2014)
...
## V. 5Miles: Building a Local C2C Marketplace in America (2014–2021)

In 2014 I moved to Dallas, Texas, and founded [5Miles](https://5miles.com) — a hyperlocal C2C marketplace where neighbors within a 5-mile radius could trade used furniture, phones, cars, and local services.
...
## VI. Clapper: A Creator Community Born in the Pandemic (2020–present)
...
## VII. ByteTrade Lab: AI and Robotics, the Next Stop (2022–present)

Since 2022 I've been spending more of my time at **ByteTrade Lab** in Singapore as CEO, focused on frontier research and product incubation in AI, robotics, and Web3. The company has closed two financing rounds — one in 2022 and another in 2026 — totaling **more than $100M**, led by SIG Asia, BAI Capital, Blue Pool Capital, and PCG (PCCW).

Our core product line is [**Olares**](https://www.olares.com/):

- **Olares OS** — an open-source personal cloud operating system that runs on hardware you own, letting you host your own data, AI models, apps, and identity the way you'd run a personal server. The mission in one line: *Let people own their data again.*
- **Olares One** — our turnkey hardware device launched in 2026, shipped with Olares OS preinstalled, so an ordinary user can have a "private cloud + AI home server" sitting in the living room without building one from scratch.
...
|------|-------|-----------|
| 2006 | *Search Engine Principles and Methods* | Publishing House of Electronics Industry |
| 2005 | "Significance Calculation and a New Analysis Method in Searching for New Physics at the LHC" | SMU Physics Preprint |
| 2000 | *UNIX Network Administration* | Tsinghua University Press |
| 2000 | *UNIX Practical Handbook* | China Machine Press |
...
- **Dallas Business Journal** — multiple in-depth profiles of 5Miles
- **PYMNTS** — 5Miles funding coverage
- **Business Wire** — KTX.Finance $4M funding round
- **Crunchbase** — entrepreneur and investor profile
...
- Email: see the portfolio homepage
